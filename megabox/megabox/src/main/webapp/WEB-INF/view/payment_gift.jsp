    ...
    <div id="contents">
        <div class="inner-wrap">
            <div class="payment-gift">
                ...
                <div id="gift" style="display: block;">
                    <h3 class="tit mt">선물 메세지</h3>
                    <div class="table-wrap">
                        <table class="board-form">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">
                                        <label for="get_user">받는 분</label>
                                    </th>
                                    <td>
                                        <input type="text" id="get_user" class="input-text" maxlength="20">
                                    </td>
                                    <th scope="rowgroup" rowspan="2">
                                        <label for="present-message">
                                            선물메세지
                                        </label>
                                    </th>
                                    <td rowspan="2">
                                        <textarea id="present_message" cols="60" rows="5"
                                            placeholder="전달하고자 하는 메세지를 남겨보세요" class="input-textarea"
                                            style="height: 76px;"></textarea>
                                    </td>
                                </tr>
                                <th scope="row">
                                    <label for="phone">수량/휴대폰번호</label>
                                </th>
                                <td>
                                    <ul class="inputui01">
                                        <li class="li01">
                                            <select id="get_cnt" class="w100p small">
                                                <option value>선택</option>
                                                <option value="1">1</option>
                                            </select>
                                        </li>
                                        <li class="li02">
                                            <input type="tel" id="phone" placeholder="'-'없이 입력해 주세요"
                                                class="input-text numType" maxlength="11">
                                        </li>
                                        <li>
                                            <a href="#" class="button purple small">추가</a>
                                        </li>
                                    </ul>
                                </td>
                            </tbody>
                ...
                <div class="btn-group pt40">
                    <a href class="button large" id="btn_store_back">취소</a>
